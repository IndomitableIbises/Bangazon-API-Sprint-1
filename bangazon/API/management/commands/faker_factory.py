...
seeder = Seed.seeder()
from API.models import Customer, Product, Product_Type, Order, Payment_Type, Employee, Training_Prog, Emp_Training
...
class Command(BaseCommand):
  ...
  def handle(self, *args, **options):
    ...
    seeder.add_entity(Order, 10) # the number argument is the total num of rows you want created
